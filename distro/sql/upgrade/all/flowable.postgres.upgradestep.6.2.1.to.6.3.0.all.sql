alter table ACT_RU_IDENTITYLINK add column if not exists SCOPE_ID_ varchar(255);
alter table ACT_RU_IDENTITYLINK add column if not exists SCOPE_TYPE_ varchar(255);
alter table ACT_RU_IDENTITYLINK add column if not exists SCOPE_DEFINITION_ID_ varchar(255);
...
alter table ACT_RU_TASK add column if not exists SUB_TASK_COUNT_ integer;
...
alter table ACT_RU_TASK add column if not exists TASK_DEF_ID_ varchar(64);
...
alter table ACT_HI_IDENTITYLINK add column if not exists SCOPE_ID_ varchar(255);
alter table ACT_HI_IDENTITYLINK add column if not exists SCOPE_TYPE_ varchar(255);
alter table ACT_HI_IDENTITYLINK add column if not exists SCOPE_DEFINITION_ID_ varchar(255);
