...
alter table ACT_RU_JOB add column if not exists CREATE_TIME_ timestamp;
alter table ACT_RU_TIMER_JOB add column if not exists CREATE_TIME_ timestamp;
alter table ACT_RU_SUSPENDED_JOB add column if not exists CREATE_TIME_ timestamp;
alter table ACT_RU_DEADLETTER_JOB add column if not exists CREATE_TIME_ timestamp;
